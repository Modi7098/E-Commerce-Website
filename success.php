  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
		  <?php if(!empty($user_data['Name'])){
			echo '<a class="nav-link active" aria-current="page" href="success.php">success</a>';
		  }?>
          </li>
          <li class="nav-item">
		  <?php if(empty($user_data['Name'])){
    ...
    <div class="jumbortron btn-secondary text-center" style="padding-bottom: 29rem; padding-top: 5rem;">
        <h5>Your order is confirmed. Thank you for shopping with us. <a href="product.php">Click here</a> to purchase any other item.</h5>
      </div>
